            ...
            child: BlocBuilder<ProductBloc, ProductState>(
              ...
              return Column(
                ...
                children: [
                      ...
                      Expanded(
                        child: TextFormField(
                          ...
                          decoration: InputDecoration(
                            hintText: 'Procurar por nome ou código de barras',
                            prefixIcon: Icon(
                              Icons.search,
                  ...
                  const Text('Toque no ícone para abrir a câmara',
            ...
            child: BlocConsumer<ProductBloc, ProductState>(
              ...
              builder: (context, state) {
                ...
                if (state.products.isEmpty) {
                  ...
                  return const Center(
                      child: Text('Ainda não há produtos. Adicione o primeiro!'));
                }
                ...
                if (filteredProducts.isEmpty) {
                  return const Center(
                      child: Text('Nenhum produto corresponde à sua procura.'));
                }
    ...
    showDialog(
      ...
      builder: (innerContext) {
        return AlertDialog(
          ...
          content: Text('Tem a certeza de que quer eliminar ${product.name}?'),
          actions: [
            TextButton(
