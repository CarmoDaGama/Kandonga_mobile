        ...
        child: Column(
          children: [
                        ...
                        children: [
                          Text(
                            state.connectedMac != null
                                ? (state.connectedName ?? 'Impressora ligada')
                                : 'Nenhuma impressora ligada',
                            style: TextStyle(
            ...
            Padding(
              ...
              child: Text(
                'Para ligar um novo equipamento, toque na roda dentada para emparelhar nas definições de Bluetooth do telemóvel, depois volte aqui e toque em Atualizar.',
                style: TextStyle(
                    fontSize: 11,
              ...
              SizedBox(
                ...
                child: ElevatedButton(
                  onPressed: () {
                    ...
                    final amount = AppCurrency.parse(amountController.text);
      ...
      builder: (context) => AlertDialog(
        ...
        actions: [
          ...
          ElevatedButton(
            onPressed: () async {
              Navigator.pop(context);
              // Espera a sessão ficar gravada antes de sair, senão o próximo
              // arranque pode ainda encontrar a sessão iniciada.
