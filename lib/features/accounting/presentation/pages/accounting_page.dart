...
class _AccountingPageState extends State<AccountingPage>
  ...
  String _formatCurrency(double amount) => AppCurrency.format(amount);
        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              ...
              child: Column(
                children: [
                  _buildReportRow('Total de vendas', totalSales),
                  _buildReportRow('Total de despesas', totalExpenses),
                  _buildReportRow('Total de compras', totalPurchases),
                  const Divider(),
