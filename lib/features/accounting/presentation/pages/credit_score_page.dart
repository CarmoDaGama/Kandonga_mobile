                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          AppCurrency.formatCompact(_selectedAmount),
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 8),
                  Text(
                    'Montante: ${AppCurrency.formatCompact(_selectedAmount)}',
              ...
              Container(
                ...
                child: Row(
                  children: [
                    ...
                    Expanded(
                      child: Text(
                        'Montante selecionado: ${AppCurrency.formatCompact(_selectedAmount)}',
                        style: const TextStyle(color: Colors.white),
                      ),
                    ),
                  ],
      ...
      child: Container(
        ...
        child: Row(
          children: [
            ...
            const SizedBox(width: 12),
            Text(
              AppCurrency.formatCompact(amount),
              style: TextStyle(
                color: Colors.white,
